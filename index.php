...
<html lang="en">
  <head>
    ...
    <title>KaryoDev - Creative and Development Studio</title>
    ...
    <!-- Google Fonts -->
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@300;400;500;600&family=Poppins:wght@300;400;500;600&display=swap" rel="stylesheet">
  ...
  <body>
    ...
    <header id="header" class="fixed-top">
      <div class="container d-flex align-items-center">
        <h1 class="logo mr-auto">
          <a href="index.php"><span style="color: #0984e3">Karyo</span><span style="color: #00b894">Dev</span><span>.</span></a>
        </h1>
    ...
    <main id="main">
        ...
        <div class="container" data-aos="fade-up">
          <div class="row">
            ...
            <?php 
              ...
              $awal = strtotime('27-09-2020 00:00:00');
            ...
            <div class="col-lg-3 col-md-6 mt-5 mt-lg-0">
              <div class="count-box">
                ...
                <span data-toggle="counter-up"><?= $jam ?></span>
      ...
      <!-- <section id="team" class="team section-bg">
        <div class="container" data-aos="fade-up">
          <div class="section-title">
            <h2>Team</h2>
            <h3>Our Great <span>Team</span></h3>
            <p>Ut possimus qui ut temporibus culpa velit eveniet modi omnis est adipisci expedita at voluptas atque vitae autem.</p>
          </div>
      ...
      <!-- <section id="faq" class="faq section-bg">
        <div class="container" data-aos="fade-up">
          ...
          <ul class="faq-list" data-aos="fade-up" data-aos-delay="100">
            ...
            <li>
              <a data-toggle="collapse" class="" href="#faq1">Non consectetur a erat nam at lectus urna duis? <i class="fas fa-arrow-up"></i></a>
            ...
            <li>
              <a data-toggle="collapse" href="#faq3" class="collapsed">Dolor sit amet consectetur adipiscing elit pellentesque habitant morbi? <i class="fas fa-arrow-up"></i></i></a>
            ...
            <li>
              <a data-toggle="collapse" href="#faq4" class="collapsed">Ac odio tempor orci dapibus. Aliquam eleifend mi in nulla? <i class="fas fa-arrow-up"></i></i></a>
      ...
      <section id="contact" class="contact section-bg">
        <div class="container" data-aos="fade-up">
          ...
          <div class="row" data-aos="fade-up" data-aos-delay="100">
            <div class="col-lg-6">
              <div class="info-box rounded bg-white mb-4">
                <i class="bx bx-map"></i>
                <h3>Our Address</h3>
                <p>Bulak Banteng Lor Bhineka, Surabaya, 60282</p>
              </div>
            </div>
          ...
          <div class="row" data-aos="fade-up" data-aos-delay="100">
            <div class="col-lg-12">
              <iframe
                class="mb-4 mb-lg-0 rounded"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3958.255987419812!2d112.76553461432017!3d-7.211611672804509!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd7f859668b4f47%3A0x99c2edc077a1b73d!2sGg.%20Bhinneka%20I%2C%20Bulak%20Banteng%2C%20Kec.%20Kenjeran%2C%20Kota%20SBY%2C%20Jawa%20Timur%2060127!5e0!3m2!1sid!2sid!4v1623750351406!5m2!1sid!2sid"
                frameborder="0"
    ...
    <footer id="footer">
      ...
      <div class="footer-top">
        <div class="container">
          <div class="row">
            <div class="col-8 col-md-4 footer-contact">
              <h3><span style="color: #0984e3">Karyo</span><span style="color: #00b894">Dev</span></h3>
              <p style="text-align: justify">
                is a digital startup that provides website and mobile-based information technology development services. We started our startup business in September 2020 and until now we have worked with clients from various fields such as mining, trading, transportation, to local MSMEs.
              </p>
            </div>
      ...
      <div class="container py-4">
        <div class="copyright">
          &copy; Copyright <strong><span style="color: #0984e3">Karyo</span><span style="color: #00b894">Dev</span></strong
          >. All Rights Reserved
        </div>
      </div>
    </footer>
